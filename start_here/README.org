...
1. In the app's render method,  try and output the first todo item's text.
2. Try the second.
3. Can you figure out how to output all of them?
4. Once you've figured that out,  start considering how you can build a component that accepts an array of todos and lists all of them.  This will
...
3. In your todo list items, add a Lens checkbox to the left of the todo text that when checked,
   will call up to toggle its completeness.
