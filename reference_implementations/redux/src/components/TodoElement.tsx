...
// Internal state for when to show the the delete button.
...
export class TodoElement extends React.Component<TodoElementProps, TodoElementState> {
  ...
  // Utility methods to show a delete button for the given todo item.
  public mouseEnter = () => {
        ...
        <Flex alignItems="center" justifyContent="space-between">
          ...
          </Flex>
          {
            this.state.showRemoveUx && <Button size="small"
                                               variant="transparent"
                                               onClick={this.deleteTodo}><IconClose /></Button>
          }
        </Flex>
      </ListItem>
    )
